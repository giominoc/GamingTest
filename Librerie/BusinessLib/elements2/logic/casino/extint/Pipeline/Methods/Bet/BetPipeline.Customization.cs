...
{
    /// <summary>
    /// Customizer per la pipeline Bet.
    ...
    /// </summary>
    public static class BetPipelineCustomizer
    {
        /// <summary>
        /// Applica customizzazioni al piano Bet basandosi sull'integrazione.
        /// 
        ...
        /// </summary>
        public static void ApplyCustomizations(PipelinePlan<BetContext> plan, string integration)
        {
        ...
        /// </summary>
        private static void ApplyCasinoAMCustomizations(PipelinePlan<BetContext> plan)
        {
            // ESEMPIO 1: Replace del componente RequestValidation con implementazione CasinoAM
            plan.Replace("RequestValidation", new PipelineComponent<BetContext>(
                "RequestValidation",
                ctx => {
                    ...
                    ctx.CmbType = it.capecod.gridgame.business.elements2.logic.casino.CasinoMovimentiBuffer.Type.Loose;
            ...
            plan.Replace("LoadSession", new PipelineComponent<BetContext>(
                "LoadSession",
                ctx => {
                    try
                    {
            ...
            plan.Replace("ExecuteExternalTransfer", new PipelineComponent<BetContext>(
            ...
            /*
            plan.InsertAfter("RequestValidation", new PipelineComponent<BetContext>(
                "CasinoAMPreCheck",
                ctx => {
        ...
        /// </summary>
        private static void ApplyExampleProviderCustomizations(PipelinePlan<BetContext> plan)
        {
            ...
            plan.InsertAfter("IdempotencyLookup", new PipelineComponent<BetContext>(
