...
{
    /// <summary>
    /// Definizioni di Hook + hook base/abstract per la pipeline di Win (Credit/Deposit).
    /// </summary>
    public abstract class WinHooks : CasinoExtIntPipelineBase
    {
        // =====================================================================
        //  Win pipeline hooks
        // =====================================================================
        ...
        /// <summary>
        /// Hook standard della pipeline Win.
        /// </summary>
        public enum WinHook
        {
            // Macro-flow
        ...
        /// </summary>
        protected virtual void CustomizeWinSteps(List<Step<WinCtx>> steps) { }

        // =====================================================================
        //  Win hook implementations
        // =====================================================================

        /// <summary>
        /// (1) RESPONSE DEFINITION
        /// </summary>
        protected virtual void Win_ResponseDefinition(WinCtx ctx)
        {
        ...
        /// </summary>
        protected virtual void Win_ContextBaseGeneration(WinCtx ctx)
        {
        ...
        /// </summary>
        protected abstract void Win_RequestValidation(WinCtx ctx);

        /// <summary>
        /// (4) IDEMPOTENCY CHECK
        /// </summary>
        protected virtual void Win_IdempotencyLookup(WinCtx ctx)
        {
        ...
        /// </summary>
        protected abstract void Win_LoadSession(WinCtx ctx);

        /// <summary>
        /// (6) CREATE MOVEMENT
        /// </summary>
        protected virtual void Win_CreateMovement(WinCtx ctx)
        {
        ...
        /// <summary>
        /// (7) PERSIST MOVEMENT (CREATE)
        /// </summary>
        protected virtual void Win_PersistMovementCreate(WinCtx ctx)
        {
            if (ctx.NewMov == null)
                return;
        ...
        /// <summary>
        /// (8) EXECUTE EXTERNAL TRANSFER
        /// Abstract: provider-specific wallet communication
        /// </summary>
        protected abstract void Win_ExecuteExternalTransfer(WinCtx ctx);

        /// <summary>
        /// (9) PERSIST MOVEMENT (FINALIZE)
        /// </summary>
        protected virtual void Win_PersistMovementFinalize(WinCtx ctx)
        {
            if (ctx.NewMov == null)
                return;
        ...
        /// (10) BUILD RESPONSE
        /// </summary>
        protected virtual void Win_BuildResponse(WinCtx ctx)
        {
        ...
        /// (11) RESEND
        /// </summary>
        protected virtual void Win_Resend(WinCtx ctx)
        {
