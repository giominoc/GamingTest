...
{
    public sealed class AMWalletRules : IProviderWalletRules
    {
        public string Provider => "AM";
        ...
        public async Task<WalletResult> ExecuteWalletAsync(WalletContext context, IWalletSharedHelpersContract helpers, CancellationToken cancellationToken = default)
        {
            ...
            return WalletResult.Ok(balance, $"AM-{request.TransferId}");
        }
    }

    public sealed class AMWalletCore : BaseProviderWalletCore
    {
        public AMWalletCore(IWalletSharedHelpersContract helpers) : base(new AMWalletRules(), helpers)
        {
        }
    }
}
